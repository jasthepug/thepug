(function($) {
    $.fn.formToWizard = function(options) {
        ...
        function selectStep(i) {
			...
			if(i == 1) {$('.finance').css('background-image' , 'url(img/property.jpg)');	}
			if(i == 3) {$('.finance').css('background-image' , 'url(img/employ.jpg)');	}
			if(i == 5) {$('.finance').css('background-image' , 'url(img/img14.jpg)');	}
			if(i == 9) {$('.finance').css('background-image' , 'url(img/identity.jpg)');	}
